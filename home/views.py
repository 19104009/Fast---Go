...
def adminlogin(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            messages.success(request, "Invalid credentials")
    dic = {'msg': msg}
    return render(request,"adminlogin.html",dic)
...
def adminDashboard(request):
    ...
    return render(request, 'admindashboard.html', locals())
...
def view_category(request):
    ...
    return render(request, 'view_cat.html', locals())
...
def edit_category(request, pid):
    ...
    if request.method == "POST":
        ...
        messages.success(request, "Category added")
        return redirect('view_cat')
    return render(request,'edit_cat.html', locals())
...
def view_product(request):
    ...
    return render(request, 'view_pro.html', locals())
def edit_product(request, pid):
    ...
    return render(request, 'edit_pro.html', locals())
